...
export default function SignInPage() {
  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <SignInContent isLoading={isLoading} setIsLoading={setIsLoading} email={email} setEmail={setEmail} router={router} />
    </Suspense>
  );
}

function SignInContent({ isLoading, setIsLoading, email, setEmail, router }: { isLoading: boolean; setIsLoading: React.Dispatch<React.SetStateAction<boolean>>; email: string; setEmail: React.Dispatch<React.SetStateAction<string>>; router: ReturnType<typeof useRouter> }) {
